...
export default function BrowsePage() {
  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', background: 'var(--terminal-bg)', color: 'var(--terminal-text)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          <div style={{ fontSize: '4rem', marginBottom: '1rem' }}>⏳</div>
          <div style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--terminal-amber)' }}>LOADING DATABASE...</div>
        </div>
      </div>
    );
  }
